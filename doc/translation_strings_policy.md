...
This document provides guidelines for internationalization of the Leprechain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `leprechain_en.ts` remains unchanged.
