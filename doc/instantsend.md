...
This mechanism has been integrated into Bitcore-Node-Leprechain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/leprechainpay/insight-api-leprechain#web-socket-api](https://github.com/leprechainpay/insight-api-leprechain#web-socket-api)
* API: [https://github.com/leprechainpay/insight-api-leprechain#instantsend-transactions](https://github.com/leprechainpay/insight-api-leprechain#instantsend-transactions)
