...
- [`595826ad6`](https://github.com/Leprechain/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`b451094e2`](https://github.com/Leprechain/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`9a5b798e9`](https://github.com/Leprechain/commit/9a5b798e9) Merge #10957: Avoid returning a BIP9Stats object with uninitialized values
...
- [`74325db11`](https://github.com/Leprechain/commit/74325db11) Merge #10859: RPC: gettxout: Slightly improve doc and tests
...
- [`9f71ab04b`](https://github.com/Leprechain/commit/9f71ab04b) remove chainparams from method call (10758)
...
- [`c62c7ab6d`](https://github.com/Leprechain/commit/c62c7ab6d) Merge #10662: Initialize randomness in benchmarks
...
- [`e5c94eea0`](https://github.com/Leprechain/commit/e5c94eea0) Merge #10765: Tests: address placement should be deterministic by default
...
- [`33807c8ce`](https://github.com/Leprechain/commit/33807c8ce) Merge #11000: test: Add resendwallettransactions functional tests
...
- [`6320d516b`](https://github.com/Leprechain/commit/6320d516b) Merge #10535: [qa] fundrawtx: Fix shutdown race
...
- [`526036ead`](https://github.com/Leprechain/commit/526036ead) Merge #9804: Fixes subscript 0 (&var[0]) where should use (var.data()) instead.
...
- [`5eca7445a`](https://github.com/Leprechain/commit/5eca7445a) Merge #10412: Improve wallet rescan API
...
- [`0cb552a20`](https://github.com/Leprechain/commit/0cb552a20) Merge #10377: Use rdrand as entropy source on supported platforms
...
- [`3fe858e53`](https://github.com/Leprechain/commit/3fe858e53)  wait for node1 in fundrawtransaction(-hd).py tests
...
- [`6bfbe6053`](https://github.com/Leprechain/commit/6bfbe6053) Scripted diff `find src/ -name "*.cpp" ! -wholename "src/util.h" ! -wholename "src/util.cpp" | xargs perl -i -pe 's/(?<!\.)(ParseParameters|ReadConfigFile|IsArgSet|(Soft|Force)?(Get|Set)(|Bool|)Arg(s)?)\(/gArgs.\1(/g'` based on bb81e1735575e1c00e808326735168cc9810c174
...
- [`c4bd31a4e`](https://github.com/Leprechain/commit/c4bd31a4e) Merge #10404: doc: Add logging to FinalizeNode()
...
- [`b13d92079`](https://github.com/Leprechain/commit/b13d92079) Merge #10322: Use hardware timestamps in RNG seeding
...
- [`f097b2d94`](https://github.com/Leprechain/commit/f097b2d94) Merge #10281: doc: Add RPC interface guidelines
...
- [`186f7d286`](https://github.com/Leprechain/commit/186f7d286) Implement support for explicit enum serialization
...
- [`0b232fd1c`](https://github.com/Leprechain/commit/0b232fd1c) Merge #10208: [wallet] Rescan abortability
...
- [`67c735b15`](https://github.com/Leprechain/commit/67c735b15) s/bitcoin-config.h/leprechain-config.h/
...
- [`0d2f2b361`](https://github.com/Leprechain/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/Leprechain/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/Leprechain/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/Leprechain/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/Leprechain/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/Leprechain/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/Leprechain/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/Leprechain/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/Leprechain/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/Leprechain/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/Leprechain/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/Leprechain/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/Leprechain/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/Leprechain/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/Leprechain/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/Leprechain/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/Leprechain/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/Leprechain/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/Leprechain/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/Leprechain/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/Leprechain/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/Leprechain/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/Leprechain/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/Leprechain/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/Leprechain/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/Leprechain/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/Leprechain/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/Leprechain/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/Leprechain/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/Leprechain/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/Leprechain/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/Leprechain/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/Leprechain/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/Leprechain/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/Leprechain/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/Leprechain/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/Leprechain/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/Leprechain/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/Leprechain/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/Leprechain/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/Leprechain/commit/1cfda206a) Merge #9993: Initialize nRelockTime
