# Leprechain Core version v19.3.0
...
- `wipetxes`: New command for `leprechain-wallet` that removes all wallet transactions
...
See detailed [set of changes](https://github.com/Leprechain/compare/v19.2.0...leprechainpay:v19.3.0).
