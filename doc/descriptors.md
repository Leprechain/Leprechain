# Support for Output Descriptors in Leprechain Core

Since Leprechain Core v0.17, there is support for Output Descriptors. This is a
...
existing Leprechain Core wallets, a convenience function `combo` is
...
All RPCs in Leprechain Core will include the checksum in their output. Only
