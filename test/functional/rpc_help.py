...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: Leprechain's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'Leprechain', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
