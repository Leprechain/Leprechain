...
"""Test the leprechain specific ZMQ notification interfaces."""
...
from test_framework.test_framework import LeprechainTestFramework
...
class LeprechainZMQTest (LeprechainTestFramework):
    def set_test_params(self):
        ...
        self.set_leprechain_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_leprechain_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that leprechaind has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all leprechain related ZMQ publisher
