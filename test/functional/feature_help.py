...
"""Verify that starting leprechaind with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start leprechaind with -h for help text")
        ...
        self.log.info("Start leprechaind with -version for version information")
        ...
        self.log.info("Start leprechaindd with -fakearg to make sure it does not start")
