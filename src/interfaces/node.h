...
//! Interface for the src/evo part of a leprechain node (leprechaind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a leprechain node (leprechaind process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a leprechain node (leprechaind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a leprechain node (leprechaind process).
...
//! Top-level interface for a leprechain node (leprechaind process).
class Node
{
public:
    virtual ~Node() {}
