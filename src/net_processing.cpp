 ...
 *  We have 4 times smaller block times in Leprechain, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        Leprechain Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // LPC this code also handles non-TXs (Leprechain specific messages)
