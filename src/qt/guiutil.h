...
/** Utility functions used by the Leprechain Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "leprechain:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load leprechain specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a leprechain specific theme is activated (light/dark).*/
