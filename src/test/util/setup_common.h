...
/* Initialize Leprechain-specific components after chainstate initialization */
void LeprechainTestSetup(NodeContext& node);
void LeprechainTestSetupClose(NodeContext& node);
