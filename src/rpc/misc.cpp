...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"leprechain\" activates all Leprechain-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "leprechain")
    + HelpExampleRpc("debug", "leprechain+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The leprechain address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The leprechain address to use for the signature."},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The difference of Leprechaunis"},
        ...
        RPCResult{
            RPCResult::Type::ARR, "", "",
            {
                {RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::NUM, "satoshis", "The number of Leprechaunis of the output"},
...
static UniValue getaddressbalance(const JSONRPCRequest& request)
{
    RPCHelpMan{"getaddressbalance",
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "",
                {
                    {RPCResult::Type::NUM, "balance", "The current total balance in Leprechaunis"},
                    {RPCResult::Type::NUM, "balance_immature", "The current immature balance in Leprechaunis"},
                    {RPCResult::Type::NUM, "balance_spendable", "The current spendable balance in Leprechaunis"},
                    {RPCResult::Type::NUM, "received", "The total number of Leprechaunis received (including change)"},
                }},
        RPCExamples{
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "leprechain-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* Leprechain features */
    { "leprechain",               "mnsync",                 &mnsync,                 {} },
    { "leprechain",               "spork",                  &spork,                  {"command"} },
    { "leprechain",               "sporkupdate",            &sporkupdate,            {"name","value"} },
