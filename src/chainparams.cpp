 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1718010983, nBits=1e0ffff0, nNonce=696246, vtx=1)
...
{
    const char* pszTimestamp = "leprechaun will find the gold pot";
    const CScript genesisOutputScript = CScript() << ParseHex("04885e92e7e02b3dcceddbc865905757368e47a52c425ba470f9339db620fa545f9219a62a8aa1a64f1ef2f310f44810eba1a6c6888911b3b1d6dbc3538b9cec53") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 1 + 24; // V19 activation height + miner confirmation window
        ...
        consensus.defaultAssumeValid = uint256S("0x0000051082e5d85514f361beac02465f27e1c14ec8f5711d873cb5fe5b34a0d9"); 
        ...
        genesis = CreateGenesisBlock(1718010983, 696246, 0x1e0ffff0, 1, 500 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000051082e5d85514f361beac02465f27e1c14ec8f5711d873cb5fe5b34a0d9"));
        assert(genesis.hashMerkleRoot == uint256S("0x740fd855099c6ee344628b799d5f0afe92da5ac67889ad501d5922abf4b578e1"));
        ...
        vSeeds.emplace_back("108.61.189.120");
        vSeeds.emplace_back("209.250.241.65");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,49);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,176);
        // Leprechain BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Leprechain BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Leprechain BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"LWKtW12r84fUwLttbFtbSDMwGsGJsURp8w"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000051082e5d85514f361beac02465f27e1c14ec8f5711d873cb5fe5b34a0d9")},
            }
        };
        ...
        // getchaintxstats 17280 0000051082e5d85514f361beac02465f27e1c14ec8f5711d873cb5fe5b34a0d9
        chainTxData = ChainTxData{
                1718010983, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockMaturityWindow = 24;
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000030fa1ce84d55276058fe6c49020b773c8dc5a38126da2822001036a9a6b"); 
        ...
        genesis = CreateGenesisBlock(1718010988UL, 655961UL, 0x1e0ffff0, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000030fa1ce84d55276058fe6c49020b773c8dc5a38126da2822001036a9a6b"));
        assert(genesis.hashMerkleRoot == uint256S("0x740fd855099c6ee344628b799d5f0afe92da5ac67889ad501d5922abf4b578e1"));
        ...
        // Testnet Leprechain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Leprechain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Leprechain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"M9u4s9tQ56ubQpyPHT1QbGK92fFBoTkZ5Z"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000030fa1ce84d55276058fe6c49020b773c8dc5a38126da2822001036a9a6b")},
            }
        };
        ...
        // getchaintxstats 17280 0000030fa1ce84d55276058fe6c49020b773c8dc5a38126da2822001036a9a6b
        chainTxData = ChainTxData{
                1718010988, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1718010993, 2, 0x207fffff, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x40b3b0a5de5dd0a57e895795d60bab0a29c1c20cfef37156e30e340f2f99aad1"));
        assert(genesis.hashMerkleRoot == uint256S("0x740fd855099c6ee344628b799d5f0afe92da5ac67889ad501d5922abf4b578e1"));
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x40b3b0a5de5dd0a57e895795d60bab0a29c1c20cfef37156e30e340f2f99aad1")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 6zHi2WsDEvqGWY6sbrBTTR3GGhixNjchNLR6CchBjF5zMwKLwwQ
        vSporkAddresses = {"MFp2rkfq9nKgfCkDAJHvGZzntN7ekypxjt"};
        nMinSporkKeys = 1;
        ...
        // Regtest Leprechain addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,50);
        // Regtest Leprechain script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,51);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,178);
        // Regtest Leprechain BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Leprechain BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Leprechain BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
