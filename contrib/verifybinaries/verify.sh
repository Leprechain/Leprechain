...
RCSUBDIR="test"
HOST1="https://github.com/Leprechain/releases/download/v"
HOST2="https://pasta.keybase.pub/Leprechain-Core-Releases/"
BASEDIR=""
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the Leprechain Core binary release signing key installed?"
   fi
