# Bootstrappable Leprechain Core Builds

This directory contains the files necessary to perform bootstrappable Leprechain
Core builds.
...
To build Leprechain Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Leprechain Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/leprechain-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/leprechainpay/guix.sigs).
...
[guix-docker]: https://github.com/Leprechain/tree/master/contrib/guix/Dockerfile
