...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The Leprechain Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a Leprechain Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Leprechain Core developers'
...
Arguments:
    <base_directory> - The base directory of Leprechain Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Leprechain Core repository.
"""
